...
public class HomeActivityVer2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.home_cart_icon:
                Intent cart_intent = new Intent(HomeActivityVer2.this, MyCartActivity.class);
                startActivity(cart_intent);
                return true;
            case R.id.home_notification_icon:
                try {
                    Intent notification_intent = new Intent(HomeActivityVer2.this, Notification.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_add_image){
            ...
            Intent homeIntent = new Intent(HomeActivityVer2.this, HomeFragment.class);
            ...
            Intent intent = new Intent(HomeActivityVer2.this, MyCartActivity.class);
            startActivity(intent);
        }
        else if(id == R.id.nav_my_account){
            Intent intent = new Intent(HomeActivityVer2.this, MyAccount.class);
            startActivity(intent);
        }
        else if(id == R.id.nav_change_password){
            Intent intent = new Intent(HomeActivityVer2.this, ChangePassword.class);
            startActivity(intent);
        }
